...
HD_PWD='R:/ECE2029/ECE2029-Final-Project/finalProject/finalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RockPaperScissors.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RockPaperScissors.tcl -notrace
