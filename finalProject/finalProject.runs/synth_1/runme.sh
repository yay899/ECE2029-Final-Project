...
HD_PWD='R:/ECE2029/ECE2029-Final-Project/finalProject/finalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RockPaperScissors.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RockPaperScissors.tcl
